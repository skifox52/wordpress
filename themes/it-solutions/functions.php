...
define('IT_SOLUTIONS_SKTTHEMES_URL','https://www.sktthemes.org/');
define('IT_SOLUTIONS_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/it-solution-wordpress-theme/');
define('IT_SOLUTIONS_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-software-company-wordpress-theme/');
define('IT_SOLUTIONS_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/itsolution-documentation/');
define('IT_SOLUTIONS_SKTTHEMES_LIVE_DEMO','https://sktperfectdemo.com/demos/it-solutions/');
define('IT_SOLUTIONS_SKTTHEMES_THEMES','https://www.sktthemes.org/themes/');
/**
...
add_action( 'tgmpa_register', 'it_solutions_register_required_plugins' );
 
function it_solutions_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Templates',
			'slug'      => 'skt-templates',
